...
document.addEventListener("touchstart", (e)=>{
	...
	startY = e.touches[0].eclientY;

});

//prevent scrolling if touch input is recieved.
...
document.addEventListener("touchend", (e) =>{
	...
	//check if the element triggered the event has classname tile.
	if(!e.target.className.includes("tile")){
	...
	//check if the horizontal swipe is greater than magnitude the vertical swipe.
